...
const AmazonAdapter_1 = require("./persistence/AmazonAdapter");
...
const persistenceAdapter = new AmazonAdapter_1.AmazonPersistenceAdapter(process.env.DYNAMODB_TABLE ?? 'baby-tracker-data');
